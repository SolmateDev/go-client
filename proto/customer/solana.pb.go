...
var file_zzzz_customer_solana_proto_rawDesc = []byte{
	...
	0x1a, 0x09, 0x6a, 0x6f, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x99, 0x03, 0x0a, 0x06,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x21, 0x5a, 0x1f, 0x6e, 0x6f, 0x6e, 0x63, 0x65,
...
var file_zzzz_customer_solana_proto_depIdxs = []int32{
	...
	6,  // 6: customer.Solana.LinkAccount:output_type -> solana.LinkResponse
	7,  // 7: customer.Solana.SubscribeAccount:output_type -> solana.AccountSubscribeResponse
	8,  // 8: customer.Solana.CreateValidator:output_type -> job.Job
	9,  // 9: customer.Solana.ListValidator:output_type -> solana.ValidatorList
	3,  // 10: customer.Solana.DestroyValidator:output_type -> base.Empty
	10, // 11: customer.Solana.SendTx:output_type -> solana.SendBatchResponse
